...
_def("opt_max_discharge", int(DAM_CONFIG["seomjin"].get(
    "max_discharge_hard", DAM_CONFIG["seomjin"]["max_discharge"])))
...
with st.sidebar:
    ...
    st.markdown("### 🚧 방류량 제약")
    _max_hard = int(DAM_CONFIG["seomjin"].get("max_discharge_hard",
                    DAM_CONFIG["seomjin"]["max_discharge"]))
